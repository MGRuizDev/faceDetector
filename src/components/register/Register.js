    ...
    <main className="pa4 black-80">
      <form className="measure">
        <fieldset id="sign_up" class="ba b--transparent ph0 mh0">
          <legend className="f4 fw6 ph0 mh0 center">Register</legend>
           <div class="mt3">
            ...
            <input className="pa2 input-reset ba bg-transparent hover-bg-black hover-white w-50" type="name" name="name"  id="name" ></input>
          </div>
          <div class="mt3">
        ...
        <div className="">
          ...
          type="submit" value="Sign in" onClick={() => signinChange('signin') }></input>
        </div>
      </form>
    </main>
   </article>
